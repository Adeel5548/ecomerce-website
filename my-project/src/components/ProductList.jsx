...
const ProductList = () => {
  ...
  return (
    <div className="bg-red-100 min-h-[88vh] py-10 px-4 sm:px-8">
      <h2 className="text-3xl font-bold text-center text-gray-800 mb-10"> Our Trending Products</h2>
      ...
      <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        {products.slice(0, 9).map((product) => (
          ...
          >
            ...
            {/* Name below image (hidden on hover) */}
